...
<div id="application-sidebar"
    ...
    <div class="flex sticky top-0 items-center justify-center px-6 h-18 border-b border-dashed border-default-200">
        <a href="{{ route("admin.index") }}">
            <img src="{{ getImageFromStorage(option("logo_dark"), "images/logo-dark.png") }}" alt="logo"
                 class="h-10 flex dark:hidden">
            <img src="{{ getImageFromStorage(option("logo_light"), "images/logo-light.png") }}" alt="logo"
                 class="h-10 hidden dark:flex">
        </a>
    </div>
    ...
    <div class="h-[calc(100%-210px)]" data-simplebar>
        <ul class="admin-menu p-4 w-full flex flex-col gap-1.5">
            <li class="menu-item">
                <a @class([
                        "flex items-center gap-x-3.5 py-3 px-4 text-sm font-semibold text-default-700 rounded-md hover:bg-default-100",
            ...
            <li class="menu-item">
                <a class="flex items-center gap-x-3.5 py-3 px-4 text-sm font-semibold text-default-700 rounded-md hover:bg-default-100"
            ...
            <li class="menu-item">
                <a href="javascript:void(0)" data-hs-collapse="#menuOrders"
                   class="hs-collapse-toggle flex items-center gap-x-3.5 py-3 px-4 text-sm font-semibold text-default-700 rounded-md hover:bg-default-100">
                ...
                <div id="menuOrders" class="hs-collapse w-full overflow-hidden transition-[height] duration-300 hidden">
                    <ul class="space-y-2 mt-2">
                        <li class="menu-item">
                            <a class="flex items-center gap-x-2.5 py-2 px-4 text-sm font-semibold text-default-700 rounded-md hover:bg-default-100"
            ...
            <li class="menu-item">
                <a href="javascript:void(0)" data-hs-collapse="#menuCustomers"
                   class="hs-collapse-toggle flex items-center gap-x-3.5 py-3 px-4 text-sm font-semibold text-default-700 rounded-md hover:bg-default-100">
            ...
            <li class="menu-item">
                <a href="javascript:void(0)" data-hs-collapse="#menuRestaurants"
                   class="hs-collapse-toggle flex items-center gap-x-3.5 py-3 px-4 text-sm font-semibold text-default-700 rounded-md hover:bg-default-100">
            ...
            <li class="menu-item">
                <a href="javascript:void(0)" data-hs-collapse="#menuSeller"
                   class="hs-collapse-toggle flex items-center gap-x-3.5 py-3 px-4 text-sm font-semibold text-default-700 rounded-md hover:bg-default-100">
    ...
    <ul class="admin-menu px-4 pt-8 flex flex-col gap-2">
        ...
        <li class="menu-item">
            <a class="flex items-center gap-x-3.5 py-3 px-4 text-sm font-semibold text-primary-600 rounded-md hover:bg-primary-300 hover:text-primary-800"
