    ...
    <div class="w-full lg:ps-64">
        <div class="p-6 page-content">
            ...
            <div class="flex items-center justify-between w-full mb-6">
                ...
                <span class="hidden md:flex"> {{ Breadcrumbs::render('admin.home') }}</span>
            </div>
            <div class="grid xl:grid-cols-3 grid-cols-1 gap-6">
                <div class="xl:col-span-2">
                    <div class="flex">
                        <div class="relative rounded-lg overflow-hidden bg-no-repeat bg-cover lg:bg-right bg-top bg-[url(../images/other/offer-bg2.png)] w-full">
                            ...
                            <div class="relative p-8 md:p-12">
                                ...
                                <p class="text-base text-white mb-6 max-w-lg">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt. </p>
                                <a href="javascript:void(0)" class="inline-flex items-center justify-center gap-2 rounded-full border border-primary bg-primary px-10 py-3 text-center text-sm font-semibold text-white shadow-sm transition-all duration-200 hover:border-primary-700 hover:bg-primary-500">
                                    Order Now
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="py-10">
                        ...
                        <div class="grid lg:grid-cols-4 grid-cols-2 gap-6">
                            <div class="border border-default-200 rounded-lg p-4 overflow-hidden text-center hover:border-primary transition-all duration-300">
                    ...
                    <div class="pb-10">
                        <div class="flex flex-wrap items-center justify-between gap-4 mb-10">
                            ...
                            <a href="product-grid.html" class="inline-flex items-center gap-1 text-sm text-primary font-medium hover:text-primary-500">View all <i data-lucide="chevron-right" class="h-5 w-5"></i></a>
                        </div>
                    ...
                    <div class="pb-10">
                        ...
                        <div class="grid lg:grid-cols-4 grid-cols-2 gap-6">
                            <a href="product-grid.html" class="border border-default-200 rounded-lg p-4 overflow-hidden hover:border-primary transition-all duration-300">
                                <div class="relative rounded-lg overflow-hidden divide-y divide-default-200">
                                    ...
                                    <div class="pt-2">
                                        <h4 class="text-default-800 text-xl font-semibold line-clamp-1 mb-2">Indian Food</h4>
                            ...
                            <a href="product-grid.html" class="border border-default-200 rounded-lg p-4 overflow-hidden hover:border-primary transition-all duration-300">
                                <div class="relative rounded-lg overflow-hidden divide-y divide-default-200">
                                    ...
                                    <div class="pt-2">
                                        <h4 class="text-default-800 text-xl font-semibold line-clamp-1 mb-2">Noodles</h4>
                            ...
                            <a href="product-grid.html" class="border border-default-200 rounded-lg p-4 overflow-hidden hover:border-primary transition-all duration-300">
                                <div class="relative rounded-lg overflow-hidden divide-y divide-default-200">
                                    ...
                                    <div class="pt-2">
                                        <h4 class="text-default-800 text-xl font-semibold line-clamp-1 mb-2">Red Velvet Pastry</h4>
                                        <h6 class="font-semibold text-lg text-default-500">$25.14</h6>
                                    </div>
                                </div>
                            </a><!-- end grid-cols -->
                    ...
                    <div class="border border-default-200 rounded-lg">
                        <div class="p-6">
                            <div class="mb-6">
                                ...
                                <div class="bg-no-repeat bg-cover bg-[url(../images/other/offer-bg.png)] bg-primary/10 rounded-lg">
                                    <div class="py-6 px-8">
                                        <div class="flex sm:flex-row flex-col items-center gap-6">
                                            <div class="sm:w-1/2 w-full flex items-center gap-6">
                                                <div>
                                                    <span class="inline-flex items-center justify-center h-14 w-14 bg-primary-200 text-primary shadow-md rounded-lg">
                                            ...
                                            <div class="sm:w-1/2 w-full">
                                                <div class="bg-primary rounded-lg">
                                                    <div class="p-4">
                                                        <h6 class="text-lg font-medium text-default-100 mb-1">Balance</h6>
                            ...
                            <div class="mb-6">
                                ...
                                <div class="flex items-center justify-between gap-4 mb-4">
                                    <h3 class="text-lg text-default-800 font-semibold"><i data-lucide="map-pin" class="h-5 w-5 inline align-middle text-primary"></i> 47, Victoria Street</h3>
                                    <button class="border border-primary text-primary text-xs font-medium rounded-lg py-1.5 px-4 transition-all duration-300 hover:bg-primary hover:text-white">Change</button>
                                </div>
                                <p class="text-base/relaxed text-default-500 mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</p>
                                <div class="flex items-center justify-start gap-4 mb-4">
                                    <button class="border border-default-600 text-default-900 text-xs font-medium rounded-lg py-1.5 px-4 transition-all duration-300 hover:bg-default-600 hover:text-white">Add Details</button>
                                    <button class="border border-default-600 text-default-900 text-xs font-medium rounded-lg py-1.5 px-4 transition-all duration-300 hover:bg-default-600 hover:text-white">Add Note</button>
                                </div>
                            </div>
                            ...
                            <div class="">
                                    ...
                                    <div class="my-6 border-b border-default-200">
                                        <div class="flex items-center justify-between mb-4">
                                            <div class="flex items-center gap-4">
                                                ...
                                                <div class="">
                                                    <a href="product-grid.html" class="text-base font-medium text-default-800">Pepperoni Pizza</a>
                                        ...
                                        <div class="flex items-center justify-between mb-4">
                                            <div class="flex items-center gap-4">
                                                ...
                                                <div class="">
                                                    <a href="product-grid.html" class="text-base font-medium text-default-800">Cheese Burger</a>
                                        ...
                                        <div class="flex items-center justify-between mb-4">
                                            <div class="flex items-center gap-4">
                                                <img src="assets/pizza-2-6f6035dd.png" class="h-16 w-16">
                                                <div class="">
                                                    <a href="product-grid.html" class="text-base font-medium text-default-800">Vegan Pizza</a>
                                                    <p class="text-sm font-medium text-default-800">x1</p>
                                                </div>
                                            </div>
                                ...
                                <div class="flex flex-col gap-4">
                                    <a href="javascript:void(0)" class="flex items-center justify-center gap-2 rounded-full border border-primary bg-primary px-10 py-4 text-center text-sm font-semibold text-white shadow-sm transition-all duration-200 hover:border-primary-700 hover:bg-primary-500">Checkout</a>
                                    <a href="javascript:void(0)" class="flex items-center justify-center gap-2 rounded-full border border-primary px-10 py-4 text-center text-sm font-semibold text-primary shadow-sm transition-all duration-200 hover:border-primary hover:bg-primary hover:text-white">Have a coupon code?</a>
                                </div>
