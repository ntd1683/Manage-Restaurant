<x-admin.layouts.guest>
    <div class="container">
        <div class="flex justify-center items-center lg:max-w-lg">
            <div class="flex flex-col h-full md:w-9/12 w-10/12">
                <div class="shrink">
                    <div>
                    ...
                    <div class="py-10">
                        <h1 class="text-3xl font-semibold text-default-800 mb-2">{{ __("Login") }}</h1>
                        <p class="text-sm text-default-500 max-w-md">{{ __("Log in now with attractive rewards") }}</p>
                    </div>
                    <form data-x-form data-x-form-to="{{ route("admin.process-login") }}"
                          action="{{ route("admin.process-login") }}" method="post">
                        @csrf
                        <div class="mb-6">
                            <x-forms.inputs title="Email" id="LoggingEmailAddress" name="email" data-x-field="email"
                                            :placeholder="trans('Enter your email')"/>
                            <span data-x-field-error="email" class="text-red-500"></span>
                        </div>
                        <div class="mb-6">
                            <div class="flex items-center justify-between mb-2">
                                <label class="block text-sm font-semibold text-default-900"
                        ...
                        <div class="flex mb-6">
                            <x-forms.inputs.checkbox :title="trans('Remember me')" id="form-remember"
                        ...
                        <div class="mb-6">
                            <div class="flex items-center justify-center gap-4">
                                <a href="javascript:void(0)" class="">
                                    <img src="{{ asset("images/google.svg") }}" class="h-8 w-8">
                                </a>
                            </div>
                        </div>
                    </form>
    ...
    <div>
        ...
        <div class="absolute top-0 end-0 hidden xl:flex h-5/6">
            <img src="{{ asset("images/auth-bg.png") }}" class="w-full z-0">
        </div>
    </div>
</x-admin.layouts.guest>
